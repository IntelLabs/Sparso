...
%
% Reads an LP or QP in MPS fixed format.  The problem data are
% returned in fields of the output variable problem.  This version
% of the routine uses MPS fixed format and can handle column/row
...
%
function problem=readmpsfx(filename);
%
