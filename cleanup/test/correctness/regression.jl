...
const set_matrix_property_test1 = Test(
    ...
    [
        TestPattern(r"Predef A: constant_valued symmetric_valued symmetric_structured",
                     "Test set_matrix_property."
        ),
        TestPattern(r"Predef B: constant_valued constant_structured symmetric_valued",
                     "Test set_matrix_property."
        ),
        exception_pattern
    ]
