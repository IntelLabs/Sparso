...
dsprint(level, indent, symbol_info, liveness, msgs...)   = show(level, indent, false, true, symbol_info, liveness, msgs)
dsprintln(level, indent, symbol_info, liveness, msgs...) = show(level, indent, true, true, symbol_info, liveness, msgs)